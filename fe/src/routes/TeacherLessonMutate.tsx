...
export const TeacherLessonMutate = () => {
  ...
  const onSubmit = (data: FormData) => {
    ...
    if (isEdit && id) {
      mutation.mutate(
        ...
        {
          onSuccess: () => navigate(`/teacher-lessons/${id}`),
      ...
      mutation.mutate(
        ...
        {
          onSuccess: (result) => navigate(`/teacher-lessons/${result.id}`),
          onError: (err) => setError((err as Error).message),
        },
      );
    }
...
export default TeacherLessonMutate;
