...
export const TeacherCourseMutate = () => {
  ...
  const onSubmit = (data: FormData) => {
    ...
    if (isEdit && id) {
      mutation.mutate(
        ...
        {
          onSuccess: () => navigate(`/teacher-courses/${id}`),
      ...
      mutation.mutate(
        ...
        {
          onSuccess: (result) => navigate(`/teacher-courses/${result.id}`),
          onError: (err) => setError((err as Error).message),
        },
      );
    }
...
export default TeacherCourseMutate;
